    ...
    <div class="container">
                                ...
                                <tr >
                                    <td style="width:40%">                                        
                                        <div class="transporteur-section">
                                            @if($parcel->company->id==2)  <img src="{{ asset('img/droppexblack.jpg')}}" style="width:100px" />@endif
                                            @if($parcel->company->id==3)  <img src="{{ asset('img/coliexpressblack.png')}}" style="width:100px" />@endif
                            ...
                            <div class="section-content expediteur-">
                                <table>
                                    <tr>
                                        <td>
                                            <div class="info-line">
                                                <span  style="color:black; ">ZA HOME<!--<img src="{{ asset('img/logo.png')}}" style="width:50px" />--></span>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="info-line">
        ...
        <table class="items-table">
            ...
            <tbody>
                ...
                @endphp
                <tr>
                    <td class="">{{ $item->variation->reference ??  $item->product->reference }}</td>
